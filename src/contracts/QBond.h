...
constexpr uint64 QBOND_MAX_EPOCH_COUNT1 = 1024ULL;
constexpr uint64 QBOND_MBOND_PRICE1 = 1000000ULL;
constexpr uint64 QBOND_MAX_QUEUE_SIZE1 = 10ULL;
constexpr uint64 QBOND_MIN_MBONDS_TO_STAKE1 = 10ULL;
constexpr sint64 QBOND_MBONDS_EMISSION1 = 1000000000LL;
constexpr uint64 QBOND_STAKE_LIMIT_PER_EPOCH1 = 1000000ULL;

constexpr uint16 QBOND_START_EPOCH1 = 182;
constexpr uint16 QBOND_CYCLIC_START_EPOCH1 = 190;
constexpr uint16 QBOND_FULL_CYCLE_EPOCHS_AMOUNT1 = 53;

constexpr uint64 QBOND_STAKE_FEE_PERCENT1 = 50; // 0.5%
constexpr uint64 QBOND_TRADE_FEE_PERCENT1 = 3; // 0.03%
constexpr uint64 QBOND_MBOND_TRANSFER_FEE1 = 100;

constexpr uint64 QBOND_QVAULT_DISTRIBUTION_PERCENT1 = 9900; // 99%
